"""Plots that visualize statistical results across the hyperscanning pipelines.

Post-hoc boxplots, three-panel movie effects, main-effect boxplots and
split-violin grids. Builds on tidy frames produced by ``statistics``.
"""
